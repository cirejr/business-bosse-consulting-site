      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 bg-background">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-primary/80 font-sans">
            ...
            <p>
              Le directeur de la publication est le gérant de Business & Bosse
              Consulting SARL.
            </p>
            ...
            <p>Le site est hébergé sur des serveurs sécurisés.</p>
            ...
            <p>
              ...
              graphismes, vidéos, sons, logiciels) est protégé par les droits de
              propriété intellectuelle appartenant à Business & Bosse Consulting
              SARL ou à ses partenaires.
            </p>
            <p className="mt-4">
              Toute reproduction, représentation, modification, publication ou
              transmission de tout ou partie du contenu, sans autorisation
            ...
            <p>
              ...
              purement informatif et n'ont aucune valeur contractuelle. Business
              & Bosse Consulting SARL s'efforce d'assurer l'exactitude des
              informations, mais ne peut garantir l'absence d'erreurs ou
              d'omissions.
            </p>
            ...
            <p>
              Le site peut contenir des liens vers d'autres sites. Business &
              Bosse Consulting SARL n'exerce aucun contrôle sur ces sites et
