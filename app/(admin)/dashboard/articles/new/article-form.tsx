...
export function ArticleForm({ categories, tags, mediaItems, article, isEdit = false }: ArticleFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      if (isEdit && article) {
        const { updateArticle } = await import('@/lib/actions/article-actions');
...
interface ArticleFormWrapperProps {
  ...
  tags: Tag[];
  mediaItems: MediaItem[];
  article?: ArticleFormProps['article'];
  isEdit?: boolean;
}

export default function ArticleFormWrapper(props: ArticleFormWrapperProps) {
  return <ArticleForm {...props} categories={props.categories} tags={props.tags} mediaItems={props.mediaItems} />;
}
